...
{    
    ...
    checkCudaErrors( cublasAlloc(n2, sizeof(d_A[0]), (void**)&d_A) );
    checkCudaErrors( cublasAlloc(n2, sizeof(d_B[0]), (void**)&d_B) );
    checkCudaErrors( cublasAlloc(n2, sizeof(d_C[0]), (void**)&d_C) );
    ...
    checkCudaErrors(cublasGetError());
    ...
    free(h_C);
    free(h_C_ref);
    checkCudaErrors( cublasFree(d_A) );
    checkCudaErrors( cublasFree(d_B) );
    checkCudaErrors( cublasFree(d_C) );
